  ...
  C.main ~name:"GLib" (fun c ->
    ...
    let conf =
      ...
      | Some pc ->
         ...
         { libs = (libffi.P.libs @ glib.P.libs) @ ["-L/usr/lib/x86_64-linux-gnu";"-L/usr/lib"];
           cflags = (libffi.P.cflags @ glib.P.cflags) @ ["-I/usr/include"; "-I/usr/include/x86_64-linux-gnu"] }    in
