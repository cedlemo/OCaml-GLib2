...
let add_group =
foreign "g_option_context_add_group" (ptr t_typ @-> ptr OptionGroup.t_typ @-> returning (void))
let add_main_entries =
foreign "g_option_context_add_main_entries" (ptr t_typ @-> ptr OptionEntry.t_typ @-> string_opt @-> returning (void))
let free =
...
let get_help =
foreign "g_option_context_get_help" (ptr t_typ @-> bool @-> ptr_opt OptionGroup.t_typ @-> returning (string))
...
let get_main_group =
foreign "g_option_context_get_main_group" (ptr t_typ @-> returning (ptr OptionGroup.t_typ))
...
let set_main_group =
foreign "g_option_context_set_main_group" (ptr t_typ @-> ptr OptionGroup.t_typ @-> returning (void))
