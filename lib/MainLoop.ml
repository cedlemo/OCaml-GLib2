...
let _new =
foreign "g_main_loop_new" (ptr t_typ @-> ptr_opt MainContext.t_typ @-> bool @-> returning (ptr t_typ))
let get_context =
foreign "g_main_loop_get_context" (ptr t_typ @-> returning (ptr MainContext.t_typ))
let is_running =
