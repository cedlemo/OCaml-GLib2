...
foreign "g_byte_array_free_to_bytes" (ptr ByteArray.t_typ @-> returning (ptr Bytes.t_typ))
...
foreign "g_compute_checksum_for_bytes" (checksumtype @-> ptr Bytes.t_typ @-> returning (string))

(* Not implemented g_compute_checksum_for_data argument types not handled . *)

let compute_checksum_for_string =
foreign "g_compute_checksum_for_string" (checksumtype @-> string @-> int64_t @-> returning (string))

let compute_hmac_for_bytes =
foreign "g_compute_hmac_for_bytes" (checksumtype @-> ptr Bytes.t_typ @-> ptr Bytes.t_typ @-> returning (string))
...
foreign "g_date_get_days_in_month" (datemonth @-> uint16_t @-> returning (uint8_t))
...
let date_valid_dmy =
foreign "g_date_valid_dmy" (uint8_t @-> datemonth @-> uint16_t @-> returning (bool))

let date_valid_julian =
foreign "g_date_valid_julian" (uint32_t @-> returning (bool))

let date_valid_month =
foreign "g_date_valid_month" (datemonth @-> returning (bool))

let date_valid_weekday =
foreign "g_date_valid_weekday" (dateweekday @-> returning (bool))
...
foreign "g_file_error_from_errno" (int32_t @-> returning (fileerror))
...
let file_test =
foreign "g_file_test" (string @-> filetest_list @-> returning (bool))
...
foreign "g_format_size_full" (uint64_t @-> formatsizeflags_list @-> returning (string))
...
foreign "g_get_current_time" (ptr TimeVal.t_typ @-> returning (void))
...
foreign "g_get_user_special_dir" (userdirectory @-> returning (string))
...
let hook_destroy =
foreign "g_hook_destroy" (ptr HookList.t_typ @-> uint64_t @-> returning (bool))

let hook_destroy_link =
foreign "g_hook_destroy_link" (ptr HookList.t_typ @-> ptr Hook.t_typ @-> returning (void))

let hook_free =
foreign "g_hook_free" (ptr HookList.t_typ @-> ptr Hook.t_typ @-> returning (void))

let hook_insert_before =
foreign "g_hook_insert_before" (ptr HookList.t_typ @-> ptr_opt Hook.t_typ @-> ptr Hook.t_typ @-> returning (void))

let hook_prepend =
foreign "g_hook_prepend" (ptr HookList.t_typ @-> ptr Hook.t_typ @-> returning (void))

let hook_unref =
foreign "g_hook_unref" (ptr HookList.t_typ @-> ptr Hook.t_typ @-> returning (void))
...
foreign "g_io_channel_error_from_errno" (int32_t @-> returning (iochannelerror))
...
foreign "g_log_default_handler" (string_opt @-> loglevelflags_list @-> string_opt @-> ptr_opt void @-> returning (void))

let log_remove_handler =
foreign "g_log_remove_handler" (string @-> uint32_t @-> returning (void))

let log_set_always_fatal =
foreign "g_log_set_always_fatal" (loglevelflags_list @-> returning (loglevelflags_list))

let log_set_fatal_mask =
foreign "g_log_set_fatal_mask" (string @-> loglevelflags_list @-> returning (loglevelflags_list))
...
let log_variant =
foreign "g_log_variant" (string_opt @-> loglevelflags_list @-> ptr Variant.t_typ @-> returning (void))
...
foreign "g_main_context_default" (void @-> returning (ptr MainContext.t_typ))

let main_context_get_thread_default =
foreign "g_main_context_get_thread_default" (void @-> returning (ptr MainContext.t_typ))

let main_context_ref_thread_default =
foreign "g_main_context_ref_thread_default" (void @-> returning (ptr MainContext.t_typ))
...
let pattern_match =
foreign "g_pattern_match" (ptr PatternSpec.t_typ @-> uint32_t @-> string @-> string_opt @-> returning (bool))

let pattern_match_simple =
foreign "g_pattern_match_simple" (string @-> string @-> returning (bool))

let pattern_match_string =
foreign "g_pattern_match_string" (ptr PatternSpec.t_typ @-> string @-> returning (bool))
...
let poll =
foreign "g_poll" (ptr PollFD.t_typ @-> uint32_t @-> int32_t @-> returning (int32_t))
...
foreign "g_regex_match_simple" (string @-> string @-> regexcompileflags_list @-> regexmatchflags_list @-> returning (bool))
...
let sequence_get =
foreign "g_sequence_get" (ptr SequenceIter.t_typ @-> returning (ptr_opt void))

let sequence_move =
foreign "g_sequence_move" (ptr SequenceIter.t_typ @-> ptr SequenceIter.t_typ @-> returning (void))

let sequence_move_range =
foreign "g_sequence_move_range" (ptr SequenceIter.t_typ @-> ptr SequenceIter.t_typ @-> ptr SequenceIter.t_typ @-> returning (void))

let sequence_remove =
foreign "g_sequence_remove" (ptr SequenceIter.t_typ @-> returning (void))

let sequence_remove_range =
foreign "g_sequence_remove_range" (ptr SequenceIter.t_typ @-> ptr SequenceIter.t_typ @-> returning (void))

let sequence_set =
foreign "g_sequence_set" (ptr SequenceIter.t_typ @-> ptr_opt void @-> returning (void))

let sequence_swap =
foreign "g_sequence_swap" (ptr SequenceIter.t_typ @-> ptr SequenceIter.t_typ @-> returning (void))
...
foreign "g_slice_get_config" (sliceconfig @-> returning (int64_t))

let slice_get_config_state =
foreign "g_slice_get_config_state" (sliceconfig @-> int64_t @-> ptr uint32_t @-> returning (ptr int64_t))

let slice_set_config =
foreign "g_slice_set_config" (sliceconfig @-> int64_t @-> returning (void))

let source_remove =
foreign "g_source_remove" (uint32_t @-> returning (bool))

let source_remove_by_funcs_user_data =
foreign "g_source_remove_by_funcs_user_data" (ptr SourceFuncs.t_typ @-> ptr_opt void @-> returning (bool))
...
foreign "g_test_expect_message" (string_opt @-> loglevelflags_list @-> string @-> returning (void))
...
let test_get_dir =
foreign "g_test_get_dir" (testfiletype @-> returning (string))

let test_incomplete =
foreign "g_test_incomplete" (string_opt @-> returning (void))

let test_log_type_name =
foreign "g_test_log_type_name" (testlogtype @-> returning (string))
...
let test_run_suite =
foreign "g_test_run_suite" (ptr TestSuite.t_typ @-> returning (int32_t))
...
foreign "g_test_trap_subprocess" (string_opt @-> uint64_t @-> testsubprocessflags_list @-> returning (void))
...
foreign "g_unicode_script_from_iso15924" (uint32_t @-> returning (unicodescript))

let unicode_script_to_iso15924 =
foreign "g_unicode_script_to_iso15924" (unicodescript @-> returning (uint32_t))
...
let utf8_normalize =
foreign "g_utf8_normalize" (string @-> int64_t @-> normalizemode @-> returning (string))
...
let variant_parse =
foreign "g_variant_parse" (ptr_opt VariantType.t_typ @-> string @-> string_opt @-> string_opt  @-> ptr_opt (ptr Error.t_typ) @-> returning (ptr Variant.t_typ))
...
foreign "g_variant_type_checked_" (string @-> returning (ptr VariantType.t_typ))
