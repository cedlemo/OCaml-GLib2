...
type t
let t_typ : t structure typ = structure "BookmarkFile"
let add_application =
foreign "g_bookmark_file_add_application" (ptr t_typ @-> string @-> string @-> string @-> returning (void))
let add_group =
...
let has_application =
foreign "g_bookmark_file_has_application" (ptr t_typ @-> string @-> string @-> returning (bool))
let has_group =
foreign "g_bookmark_file_has_group" (ptr t_typ @-> string @-> string @-> returning (bool))
let has_item =
foreign "g_bookmark_file_has_item" (ptr t_typ @-> string @-> returning (bool))
let load_from_data =
foreign "g_bookmark_file_load_from_data" (ptr t_typ @-> string @-> uint64_t @-> returning (bool))
let load_from_data_dirs =
foreign "g_bookmark_file_load_from_data_dirs" (ptr t_typ @-> string @-> string @-> returning (bool))
let load_from_file =
foreign "g_bookmark_file_load_from_file" (ptr t_typ @-> string @-> returning (bool))
let move_item =
foreign "g_bookmark_file_move_item" (ptr t_typ @-> string @-> string @-> returning (bool))
let remove_application =
foreign "g_bookmark_file_remove_application" (ptr t_typ @-> string @-> string @-> returning (bool))
let remove_group =
foreign "g_bookmark_file_remove_group" (ptr t_typ @-> string @-> string @-> returning (bool))
let remove_item =
foreign "g_bookmark_file_remove_item" (ptr t_typ @-> string @-> returning (bool))
let set_added =
foreign "g_bookmark_file_set_added" (ptr t_typ @-> string @-> int64_t @-> returning (void))
let set_app_info =
foreign "g_bookmark_file_set_app_info" (ptr t_typ @-> string @-> string @-> string @-> int32_t @-> int64_t @-> returning (bool))
let set_description =
foreign "g_bookmark_file_set_description" (ptr t_typ @-> string @-> string @-> returning (void))
let set_groups =
foreign "g_bookmark_file_set_groups" (ptr t_typ @-> string @-> string @-> uint64_t @-> returning (void))
let set_icon =
foreign "g_bookmark_file_set_icon" (ptr t_typ @-> string @-> string @-> string @-> returning (void))
let set_is_private =
...
let set_title =
foreign "g_bookmark_file_set_title" (ptr t_typ @-> string @-> string @-> returning (void))
let set_visited =
...
let to_file =
foreign "g_bookmark_file_to_file" (ptr t_typ @-> string @-> returning (bool))
let error_quark =
