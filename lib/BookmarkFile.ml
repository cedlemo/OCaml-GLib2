...
let get_title =
foreign "g_bookmark_file_get_title" (ptr t_typ @-> string  @-> ptr_opt (ptr Error.t_typ) @-> returning (string))
...
foreign "g_bookmark_file_load_from_data_dirs" (ptr t_typ @-> string @-> string  @-> ptr_opt (ptr Error.t_typ) @-> returning (bool))
let load_from_file =
foreign "g_bookmark_file_load_from_file" (ptr t_typ @-> string  @-> ptr_opt (ptr Error.t_typ) @-> returning (bool))
let move_item =
foreign "g_bookmark_file_move_item" (ptr t_typ @-> string @-> string  @-> ptr_opt (ptr Error.t_typ) @-> returning (bool))
