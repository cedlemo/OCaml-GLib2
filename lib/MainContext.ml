...
let add_poll =
foreign "g_main_context_add_poll" (ptr t_typ @-> ptr PollFD.t_typ @-> int32_t @-> returning (void))
...
foreign "g_main_context_find_source_by_funcs_user_data" (ptr t_typ @-> ptr SourceFuncs.t_typ @-> ptr_opt void @-> returning (ptr Source.t_typ))
...
let remove_poll =
foreign "g_main_context_remove_poll" (ptr t_typ @-> ptr PollFD.t_typ @-> returning (void))
let unref =
