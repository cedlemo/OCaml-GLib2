...
(* TODO Struct field Scanner : interface tag not implemented *)(* TODO Struct field Scanner : interface tag not implemented *)(* TODO Struct field Scanner : interface tag not implemented *)(* TODO Struct field Scanner : interface tag not implemented *)val f_line: (Unsigned.uint32, t structure) field
val f_position: (Unsigned.uint32, t structure) field
(* TODO Struct field Scanner : interface tag not implemented *)(* TODO Struct field Scanner : interface tag not implemented *)val f_next_line: (Unsigned.uint32, t structure) field
