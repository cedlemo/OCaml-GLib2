...
(* TODO Struct field Scanner : interface tag not implemented *)(* TODO Struct field Scanner : interface tag not implemented *)(* TODO Struct field Scanner : interface tag not implemented *)(* TODO Struct field Scanner : interface tag not implemented *)let f_line = field t_typ "line" (uint32_t)
let f_position = field t_typ "position" (uint32_t)
(* TODO Struct field Scanner : interface tag not implemented *)(* TODO Struct field Scanner : interface tag not implemented *)let f_next_line = field t_typ "next_line" (uint32_t)
